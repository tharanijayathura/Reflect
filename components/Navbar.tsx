  ...
  return (
    <>
      ...
      <style>{`
        ...
        @media (max-width:850px) { .fashion-header { padding:10px 14px; } .desktop-links { display:none; } .main-navigation { grid-template-columns:1fr auto 1fr; min-height:65px; } .mobile-menu-button { position:absolute; top:50%; right:14px; display:inline-flex; transform:translateY(-50%); } .mobile-menu-button:hover { transform:translateY(calc(-50% - 1px)); } }
